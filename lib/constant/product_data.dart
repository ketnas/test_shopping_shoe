class Product implements Comparable<Product> {
  ...
  Product(this.id, this.img, this.name, this.price, this.mul_img, this.sizes);
  ...
  @override
  int compareTo(Product other) => name?.compareTo(other.name.toString()) ?? 0;
}

Map<String, int> cart = {};
int tabBarCount = 0;

List<bool> fav_list = List<bool>.generate(products.length, (int test) => false);
bool clickedFavBottom = false;
